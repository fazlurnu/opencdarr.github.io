...
The traffic is [random traffic](../scenario/random-traffic.md): the aircraft cross a disc of 1000 m
on random headings, released on a circle of 1200 m. Each aircraft is a
[DJI M600 multirotor](../modules/kinematics/multirotor.md) at 10 m/s with a 10 m GNSS fix, the
protected zone is 50 m, and the look-ahead is 30 s. Detection is
[`StateBased`](../modules/separation/conflict-detection.md) and recovery is the
[probabilistic criterion](../modules/separation/recovery-criteria.md). The reported probability is
