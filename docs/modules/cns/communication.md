...
[`scripts/handbook/communication.py`](https://github.com/fazlurnu/OpenCDaRR/blob/main/scripts/handbook/communication.py) makes the figures on this page.

!!! code "Run it yourself"
    The notebook [`examples/handbook/communication.ipynb`](https://github.com/fazlurnu/OpenCDaRR/blob/main/examples/handbook/communication.ipynb) uses each setting on this page. It shows one timestep through the full stack, then each effect alone, then the four extension points.
