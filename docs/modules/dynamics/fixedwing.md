...
!!! note "Run it yourself"
    Every figure on this page is generated by [`examples/handbook/dynamics_fixedwing.ipynb`](https://github.com/fazlurnu/OpenCDaRR/blob/main/examples/handbook/dynamics_fixedwing.ipynb) — the same commands shown above, driving the real `FixedWing`.
